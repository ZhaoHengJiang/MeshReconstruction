...
MANIFOLD_DIR = r'/home/ubuntu/MeshReconstruction/Manifold/build'  # path to manifold software (https://github.com/hjwdzh/Manifold)
...
class Options:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--samples', type=int, metavar='N', default=20000,
                            help='number of points to sample reconstruction with')
        parser.add_argument('--begin-samples', type=int, metavar='N', default=10000, help='num pts to start with')
        ...
        parser.add_argument('--max-faces', type=int, metavar='N', default=50000,
